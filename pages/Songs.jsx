        ...
        <div className="flex flex-col min-h-full animate-fade-in">
            ...
            >
                ...
                <div className="flex flex-col gap-2 mb-2 flex-1">
                    ...
                    <h1 className="text-huge max-w-[900px] truncate leading-tight">
            ...
            {/* Action Bar */}
            <div className="px-8 py-6 flex items-center gap-8 sticky top-16 z-40">
                <button
                    onClick={() => songs.length > 0 && playSong(songs[0])}
                    className="w-14 h-14 bg-spotify-green text-black rounded-full flex items-center justify-center hover:scale-105 transition-all shadow-2xl"
                >
                    <Play fill="black" size={28} className="ml-1" />
                </button>
                    ...
                    songs.map((song, i) => {
                        ...
                        return (
                            <div
                                key={song._id}
                                onClick={() => playSong(song)}
                                className="grid grid-cols-[40px_4fr_3fr_1fr] gap-4 px-4 py-2 rounded-md hover:bg-white/10 cursor-pointer group transition-all items-center"
                            >
                                <span
                                    className={`text-sm font-medium ${
                                        isCurrent ? "text-spotify-green" : "text-subdued"
                                    }`}
                                >
                                    {i + 1}
                                </span>
                                ...
                                <div className="flex items-center gap-3 overflow-hidden">
                                    <div className="w-10 h-10 rounded overflow-hidden bg-spotify-grey">
                                        <img
                                ...
                                <span className="text-sm text-subdued flex justify-end pr-4">
                                    3:45
                                </span>
                            </div>
                        );
